...
class EodMain(UserMixin, db.Model): 
    id = db.Column(db.Integer, primary_key=True)    
    user_id = db.Column(db.Integer)
    test_code = db.Column(db.String(100), nullable=True)
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.now)
    pt_portion_col = db.Column(db.String(100), nullable=True, default='N/A')
    adjustments = db.Column(db.String(100), nullable=True, default='N/A')
    total_collection = db.Column(db.String(100), nullable=True, default='N/A')
    daily_collection = db.Column(db.String(100), nullable=True, default='N/A')
    no_show = db.Column(db.String(100), nullable=True, default='N/A')
    same_day_tx = db.Column(db.String(100), nullable=True, default='N/A')
    new_patient = db.Column(db.String(100), nullable=True, default='N/A')
    pts_miss_referral = db.Column(db.String(100), nullable=True, default='N/A')
    hyg_reappt = db.Column(db.String(100), nullable=True, default='N/A')
    case_acceptance = db.Column(db.String(100), nullable=True, default='N/A')
    
class EodBrk(UserMixin, db.Model): 
    id = db.Column(db.Integer, primary_key=True)    
    user_id = db.Column(db.Integer)
    test_code = db.Column(db.String(100), nullable=True)
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.now)
